...
|---|---|---|
| `meta-docs/` | How to build software with this kit (architecture, persistence, testing, security, stacks, conventions, workflow). Language-agnostic core + `stacks/`. | Any "how should I…" question. Start at `meta-docs/INDEX.md`. |
...
where an ID applies (`meta-docs/conventions/document-format.md`).
