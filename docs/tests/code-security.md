...
Code security — .aix/scripts, tests
  ...
  findings to review 0; in tests (not gated, --strict to gate) 1; register rows with rules 16, with findings 1
  ...
  no pattern matched for: VUL-AI-001, VUL-AI-002, VUL-AUTHN-001, VUL-AUTHN-002, VUL-DEP-001, VUL-INFRA-001, VUL-INJ-002, VUL-INPUT-001, VUL-INPUT-002, VUL-LOG-001, VUL-SECRET-001, VUL-SECRET-002, VUL-WEB-001, VUL-WEB-002, VUL-WEB-003  (rules ran; absence of a match is not evidence of absence)
