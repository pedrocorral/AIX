...
```
  ...
  functions analysed 1136; over a limit 0 (lines 0, cognitive 0, cyclomatic 0, nesting 0, params 0, pass-through 0, leftovers 0, swallowed 0, bugs 0); with any finding 454; files over 400 lines: 0
  ...
  .aix/scripts/deadcode.py:render_dead                            18     6     7     1    4   public function without a docstring / doc comment; magic number 6
  ...
  .aix/scripts/clones.py:brace_block                              15     6     5     2    2   single-letter name `i`; single-letter name `j`
  ...
  .aix/scripts/graph.py:main                                      24     8     9     1    1   single-letter name `o`; single-letter name `m`
  .aix/scripts/codesecurity.py:selftest                            9     4     7     0    0   magic number 3; magic number 4
  .aix/scripts/funcgraph.py:_File.owner                            4     1     4     1    1   magic number 3; magic number 4
  ...
  ... 424 more; narrow the target or use --all
