...
```
  ...
  functions analysed 925; over a limit 0 (lines 0, cognitive 0, cyclomatic 0, nesting 0, params 0, pass-through 0); with any finding 413; files over 400 lines: 0
  ...
  ... 383 more; narrow the target or use --all
