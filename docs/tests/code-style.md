...
```
  runtime: Python 3.13 (python on PATH (assumed: nothing in the project declares a version))
  functions analysed 864; over a limit 0 (lines 0, cognitive 0, cyclomatic 0, nesting 0, params 0); with any finding 394; files over 400 lines: 0
  ...
  .aix/scripts/vulnerabilities.py:_selftest_checks                14     2     8     1    3   magic number 4; magic number 4
  ...
  ... 364 more; narrow the target or use --all
