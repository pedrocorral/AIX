...
```
  ...
  functions analysed 983; over a limit 0 (lines 0, cognitive 0, cyclomatic 0, nesting 0, params 0, pass-through 0); with any finding 426; files over 400 lines: 0
  ...
  ... 396 more; narrow the target or use --all
