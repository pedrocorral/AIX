...
```
  ...
  functions analysed 1096; over a limit 0 (lines 0, cognitive 0, cyclomatic 0, nesting 0, params 0, pass-through 0, leftovers 0, swallowed 0, bugs 0); with any finding 447; files over 400 lines: 0
  ...
  ... 417 more; narrow the target or use --all
