...
4. Make sure every doc you created/changed is listed in its folder INDEX. Run `aix validate` and fix errors.
5. If the task is done: `aix coverage` and `aix task done <TASK>` (or equivalent), check DoD.
