...
- Modularity (`architecture/modularity.md`): no new cycle; no sibling domain import; new shared code is a leaf (no upward imports); no module gains more than ~7 project imports; no growth of `utils`/`common` hubs.
