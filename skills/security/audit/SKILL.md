...
Read: `docs/meta-docs/security/audit-process.md`; `grep -n "<component or category>" docs/security/vulnerability-register.md`; the task's `security:` list.
...
4. Write `docs/security/audits/AUDIT-<date>-<category>.md` per category (template `templates/audit-report.md`); add rows to `audits/INDEX.md`.
