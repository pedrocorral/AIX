...
Read: register rows for category AI (`grep -n "VUL-AI" docs/security/vulnerability-register.md`); `docs/meta-docs/security/secure-coding-baseline.md`; relevant meta-doc: `security/ai-llm-security.md`, `stacks/python/ai-app.md`.
...
## Procedure
1. Locate code by layer (`docs/meta-docs/architecture/project-layout.md`): `backend/app/*/{prompts,tools,adapters/<provider>}/`, AI services. Grep targeted patterns; do not read whole directories.
