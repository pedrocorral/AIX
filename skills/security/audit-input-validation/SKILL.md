...
Read: register rows for category INPUT (`grep -n "VUL-INPUT" docs/security/vulnerability-register.md`); `docs/meta-docs/security/secure-coding-baseline.md`; relevant meta-doc: `architecture/api-design.md`.
...
## Procedure
1. Locate code by layer (`docs/meta-docs/architecture/project-layout.md`): `backend/app/*/schemas/`, `controllers/`, `core/`. Grep targeted patterns; do not read whole directories.
