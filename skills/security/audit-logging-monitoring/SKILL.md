...
Read: register rows for category LOG (`grep -n "VUL-LOG" docs/security/vulnerability-register.md`); `docs/meta-docs/security/secure-coding-baseline.md`; relevant meta-doc: `architecture/errors-logging-observability.md`.
...
## Procedure
1. Locate code by layer (`docs/meta-docs/architecture/project-layout.md`): `backend/app/core/` (logging, errors), `infra/` observability config. Grep targeted patterns; do not read whole directories.
