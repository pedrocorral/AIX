...
| `newie.md`, `newie-2.md`, `newie-3.md` | AIX one screen at a time: the basics, then the loop, then making it yours (`aix newie`, `aix newie 2`, `aix newie 3`; a layer may add `newie-4.md`) | The first hour, then the first week |
