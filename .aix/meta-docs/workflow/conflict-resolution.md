...
1. **Freeze & record.** Do not change code or docs. Create `docs/conflicts/open/CONFLICT-NNNN-<title>.md` (template `.aix/templates/conflict.md`); its `affects:` scope is frozen for all agents.
...
5. **Record.** Whatever is chosen → `docs/requirements/decisions/ADR-NNNN-*.md` (template `.aix/templates/adr.md`),
