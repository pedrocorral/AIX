...
| `project-layout.md` | Recommended folder tree for a new monorepo (`backend/ frontend/ shared/ infra/`), nesting rules, where tests live | Creating files; finding files |
