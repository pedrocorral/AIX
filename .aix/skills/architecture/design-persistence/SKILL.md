...
Read: `.aix/meta-docs/persistence/abstraction-layer.md`, `orm-guidelines.md`, `switching-backends.md`; the relevant `DM-*` docs; stack notes in `.aix/meta-docs/stacks/<lang>/`.
