...
Reading order (required, ≈ 900 lines total): `.aix/meta-docs/architecture/INDEX.md` and all files it lists; `.aix/meta-docs/persistence/abstraction-layer.md`; `.aix/meta-docs/testing/strategy.md`; `.aix/meta-docs/security/audit-process.md`; the chosen `.aix/meta-docs/stacks/<lang>/`. Inputs: `docs/requirements/product/*`, existing FR/NFR.
