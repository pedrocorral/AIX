...
Reference: `.aix/meta-docs/conventions/token-economy.md`.
...
4. Code → guess the path from `.aix/meta-docs/architecture/project-layout.md` (`backend/app/<domain>/<layer>/`), `ls` that single folder.
