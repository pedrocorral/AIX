...
---
# implement-ui
Read: FR + `API-*` docs; `.aix/meta-docs/architecture/frontend-backend-separation.md`; `.aix/meta-docs/stacks/javascript/frontend.md` (or server-rendered section of the stack doc; dashboards: `stacks/python/data-science-app.md`).
