...
Read: register rows for category DATA (`grep -n "VUL-DATA" docs/security/vulnerability-register.md`); `.aix/meta-docs/security/secure-coding-baseline.md`; relevant meta-doc: `persistence/migrations-and-data-lifecycle.md`.
...
## Procedure
1. Locate code by layer (`.aix/meta-docs/architecture/project-layout.md`): `docs/requirements/data-model/`, `adapters/`, `infra/` (backups), AI adapters. Grep targeted patterns; do not read whole directories.
