...
Read: register rows for category INFRA (`grep -n "VUL-INFRA" docs/security/vulnerability-register.md`); `.aix/meta-docs/security/secure-coding-baseline.md`; relevant meta-doc: `architecture/configuration-and-secrets.md`.
...
## Procedure
1. Locate code by layer (`.aix/meta-docs/architecture/project-layout.md`): `infra/`, Dockerfiles, CI config. Grep targeted patterns; do not read whole directories.
